...
Généré le 2026-09-22 par `node scripts/docs/generate-technical-inventory.js`.
...
| --- | ---: | --- |
| Fichiers JavaScript de services (directs / récursifs) | 411 / 711 | Fichiers `.js` directement sous `backend/src/services`, puis sous-arborescence comprise |
