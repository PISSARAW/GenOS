...
- **Ollama** est déjà le runtime local de référence de GenOS (voir [MODELES_PROVIDERS.md](../../03-reference/modeles-et-providers.md)) : `ollama://model-name`, découverte automatique via [localModelDiscovery.js](../../../backend/src/services/localModelDiscovery.js).
...
- [MODELES_PROVIDERS.md](../../03-reference/modeles-et-providers.md) : routage de modèles, providers locaux et cloud
