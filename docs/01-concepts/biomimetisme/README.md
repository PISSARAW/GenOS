# Biomimétisme spécialisé

Spécialisations biologiques non humaines et perception sensorielle utilisées comme
...
- [../README.md](../README.md) — concepts et fondations.
- [../../02-orchestration/topologies-et-capacites.md](../../02-orchestration/topologies-et-capacites.md) — capacités effectives (`WEB_FORAGING`, `FOVEAL_PERCEPTION`).
