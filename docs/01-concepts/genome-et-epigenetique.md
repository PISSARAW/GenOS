...
- [AGENT_DNA_RUNTIME.md](agent-dna-runtime.md) — implémentation binaire du génome, de la chromatine (`chromatin_state`, `is_methylated`), des enhancers et des plasmides ; opérations `graft`/`speciate`.
