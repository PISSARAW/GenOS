...
const direct = defineFamily('direct', [
  ...
  ['entropy_model_escalation', 'Escalade de modèle par entropie', ['all'], ['low_cost', 'entropy', 'model_routing'], 'implemented', ['slm_route', 'entropy_check', 'frontier_escalation']],
...
const diagnosis = defineFamily('diagnosis', [
  ...
  ['bayesian_sequential_diagnosis', 'Diagnostic séquentiel bayésien', ['unknown_cause_bug', 'scientific_research'], ['information_gain', 'adaptive'], 'implemented', ['belief_update', 'expected_information_gain', 'next_probe']],
...
const exploration = defineFamily('exploration', [
  ...
  ['niche_exploration', 'Exploration par niches', ['critical_refactor', 'scientific_research'], ['diversity', 'high_compute'], 'implemented', ['speciation', 'niche_preservation', 'pareto_select']]
]);
