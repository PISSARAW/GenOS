...
const temporal = defineFamily('temporal', [
  ...
  ['causal_rebase', 'Rebase causal', ['architecture_decision', 'critical_refactor'], ['temporal', 'causal', 'high_impact'], 'implemented', ['checkpoint', 'inject_change', 'replay_dependencies']],
...
const collective = defineFamily('collective', [
  ...
  ['brier_weighted_consensus', 'Consensus pondéré par Brier', ['architecture_decision', 'scientific_research'], ['collective', 'calibration', 'multi_objective'], 'implemented', ['brier_scores', 'weighted_quorum']],
  ...
  ['stigmergy', 'Stigmergie', ['all'], ['collective', 'low_cost', 'information_gain'], 'implemented', ['pheromone_deposit', 'trail_selection', 'evaporation']],
  ['flocking_boids', 'Flocking / Boids', ['implementation', 'architecture_decision'], ['collective', 'diversity', 'parallel'], 'implemented', ['separation', 'alignment', 'cohesion']],
  ['fish_school_search', 'Fish School Search', ['implementation', 'critical_refactor'], ['collective', 'adaptive', 'parallel'], 'implemented', ['weighted_barycenter', 'resource_shift']],
  ['slime_mould_network', 'Slime-mould / réseau adaptatif', ['architecture_decision'], ['collective', 'adaptive', 'low_cost'], 'implemented', ['path_conductivity', 'route_pruning']],
  ['grey_wolf_optimizer', 'Grey Wolf Optimizer', ['implementation', 'critical_refactor'], ['collective', 'parallel', 'deep_search'], 'implemented', ['alpha_beta_delta', 'position_update']],
  ['mycelial_routing', 'Routage mycélien', ['all'], ['collective', 'low_cost', 'specialization'], 'implemented', ['capability_route', 'knowledge_transfer']],
  ['dynamic_polyethism', 'Polyéthisme et différenciation dynamique', ['critical_refactor', 'security'], ['collective', 'adaptive', 'specialization'], 'implemented', ['role_gradient', 'dynamic_assignment']],
  ['energy_huddle', 'Huddle énergétique', ['all'], ['collective', 'budget', 'adaptive'], 'implemented', ['energy_observe', 'resource_equalize']],
