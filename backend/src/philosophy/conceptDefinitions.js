...
const RAW_CONCEPT_DEFINITIONS = [
  ...
  C({ id: 'metaphysics.emergence', label: 'Émergence / propriété émergente', domain: 'metaphysics', school: 'analytic', status: 'implemented', service: 'propertyService', serviceMaturity: { level: 'implemented', executable: true, evidence: 'tests', note: 'Détecte une nouveauté au niveau du système sur un échantillon explicite ; ne prouve pas une émergence forte.' } }),
  C({ id: 'metaphysics.supervenience', label: 'Supervenience / supervenience psychophysique', domain: 'metaphysics', school: 'analytic', status: 'implemented', service: 'consciousnessService', serviceMaturity: { level: 'implemented', executable: true, evidence: 'tests', note: 'Compare des empreintes canoniques d’états fournis ; un résultat compatible ne prouve pas la thèse.' } }),
  ...
  C({ id: 'metaphysics.mind-body', label: 'Matière, esprit, conscience et problème corps-esprit', domain: 'metaphysics', school: 'mind-body', status: 'implemented', service: 'consciousnessService', serviceMaturity: { level: 'implemented', executable: true, evidence: 'tests', note: 'Compare des modèles de couplage déclaratifs ; aucun modèle n’est établi comme vrai.' } }),
  C({ id: 'metaphysics.qualia', label: 'Qualia', domain: 'phenomenology', school: 'contemporary', status: 'implemented', service: 'consciousnessService', serviceMaturity: { level: 'implemented', executable: true, evidence: 'tests', note: 'Enregistre un rapport structuré fourni par l’agent ; n’observe ni ne vérifie une expérience subjective.' } }),
  ...
  C({ id: 'metaphysics.reference-intentionality', label: 'Référence et intentionnalité', domain: 'phenomenology', school: 'brentano-husserl', status: 'implemented', service: 'phenomenologyService', serviceMaturity: { level: 'implemented', executable: true, evidence: 'tests', note: 'Enregistre un acte et sa cible déclarée ; ne démontre pas une conscience de cette cible.' } }),
  ...
  C({ id: 'epistemology.tripartite-definition', label: 'Définition tripartite : croyance vraie justifiée', domain: 'epistemology', school: 'plato-gettier', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'epistemology.certainty-doubt', label: 'Certitude / Doute', domain: 'epistemology', school: 'general', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.doxa', label: 'Opinion / Doxa', domain: 'epistemology', school: 'plato', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.propositional-knowledge', label: 'Connaissance propositionnelle', domain: 'epistemology', school: 'russell', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.acquaintance', label: 'Connaissance par acquaintance', domain: 'epistemology', school: 'russell', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.know-how', label: 'Connaissance pratique / Savoir-faire', domain: 'epistemology', school: 'ryle', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.knowledge-wh', label: 'Connaissance de type knowledge-wh', domain: 'epistemology', school: 'contemporary', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'epistemology.knowledge-first', label: 'Knowledge-first epistemology', domain: 'epistemology', school: 'williamson', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.knowledge-assertion', label: 'Knowledge account of assertion', domain: 'epistemology', school: 'williamson-turri', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'epistemology.context-discovery-justification', label: 'Contexte de découverte / justification', domain: 'epistemology', school: 'reichenbach', status: 'partial', service: 'specializedEpistemologyService' }),

  // Écoles et positions épistémologiques.
  C({ id: 'school.empiricism', label: 'Empirisme : Locke, Berkeley, Hume', domain: 'schools', school: 'locke-berkeley-hume', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'school.verificationism', label: 'Vérificationnisme et positivisme logique', domain: 'schools', school: 'vienna-circle', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'school.falsificationism', label: 'Falsificationnisme', domain: 'schools', school: 'popper', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'school.pragmatism', label: 'Pragmatisme : Peirce, James, Dewey, Rorty', domain: 'schools', school: 'pragmatism', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'school.naturalized-epistemology', label: 'Épistémologie naturalisée', domain: 'schools', school: 'quine-neurath', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'method.induction-problem', label: 'Problème de l’induction', domain: 'methods', school: 'hume-wittgenstein', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'method.surprise-predictivism', label: 'Surprise et predictivism', domain: 'methods', school: 'predictivism', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'method.dutch-book', label: 'Arguments Dutch book et cohérence', domain: 'methods', school: 'ramsey-de-finetti', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'method.bayesian-confirmation', label: 'Confirmation bayésienne', domain: 'methods', school: 'carnap-hempel', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'science.raven-paradox', label: 'Paradoxe des corbeaux', domain: 'science', school: 'hempel', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'science.progress', label: 'Progrès de la science et programmes de recherche', domain: 'science', school: 'lakatos', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'science.paradigm-incommensurability', label: 'Changements de paradigmes et incommensurabilité', domain: 'science', school: 'kuhn', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'science.normal-revolutionary', label: 'Science normale et révolutionnaire', domain: 'science', school: 'kuhn', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'science.godel-incompleteness', label: 'Théorèmes d’incomplétude et limites formelles', domain: 'science', school: 'godel', status: 'partial', service: 'specializedEpistemologyService' }),
  ...
  C({ id: 'epistemology.process-reliabilism', label: 'Process reliabilism', domain: 'epistemology', school: 'goldman', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.indicator-reliabilism', label: 'Indicator reliabilism', domain: 'epistemology', school: 'reliabilism', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.virtue-epistemology', label: 'Virtue epistemology', domain: 'epistemology', school: 'zagzebski-sosa', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.intellectual-virtue-vice', label: 'Vertu / vice intellectuel', domain: 'epistemology', school: 'virtue-epistemology', status: 'partial', service: 'specializedEpistemologyService' }),
  C({ id: 'epistemology.causal-theory-knowledge', label: 'Théorie causale de la connaissance', domain: 'epistemology', school: 'causal-epistemology', status: 'partial', service: 'specializedEpistemologyService' }),
