...
const CONCEPT_DEFINITIONS = [
  ...
  C('school.newtonianism', 'Newton : espace et temps absolus', 'schools', 'newton', 'planned'),
  C('school.kantianism', 'Kant : noumène, phénomène, catégories a priori', 'schools', 'kant', 'partial', 'epistemologyService'),
  C('school.hegelianism', 'Hegel : dialectique et Absolute Geist', 'schools', 'hegel', 'planned'),
  C('school.schopenhauer', 'Schopenhauer : volonté et représentation', 'schools', 'schopenhauer', 'planned'),
  ...
  C('time.newtonian', 'Temps absolu et espace absolu', 'time-space', 'newton', 'planned'),
  C('time.duration', 'Temps et durée', 'time-space', 'bergson-mctaggart', 'partial', 'temporalIdentityService'),
  ...
  C('process.bergsonian-vital-impulse', 'Durée / Élan vital / Intuition', 'process', 'bergson', 'planned'),
