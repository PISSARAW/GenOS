...
const ADAPTERS = {
  ...
  'epistemology.knowledge': ({ args }) => callService('knowledgeService', 'analyzeKnowledge', args), 'epistemology.belief': ({ args }) => callService('knowledgeService', 'assessBelief', args),
  'epistemology.justification': ({ args }) => callService('knowledgeService', 'assessJustification', args), 'epistemology.truth': ({ args }) => callService('knowledgeService', 'assessTruth', args),
  'epistemology.gettier-problem': ({ args }) => callService('knowledgeService', 'analyzeGettier', args), 'epistemology.gettierized-knowledge': ({ args }) => callService('knowledgeService', 'analyzeGettier', args),
  'epistemology.post-gettier-defenses': ({ args }) => callService('knowledgeService', 'assessPostGettierDefenses', args), 'epistemology.rationality-norms': ({ args }) => rationalityNorms.evaluateRationality(args),
  'epistemology.cartesian-doubt': ({ args }) => callService('cartesianService', 'methodicalDoubt', args), 'school.rationalism': ({ args }) => callService('epistemologyService', 'assessRationalism', args),
  ...
  'architecture.philosophy': ({ args }) => callService('visualCultureService', 'analyzeArchitecture', args),
  'design.philosophy': ({ args }) => callService('visualCultureService', 'analyzeDesign', args),
  'digital-art.philosophy': ({ args }) => callService('visualCultureService', 'analyzeDigitalArt', args),
  'video.philosophy': ({ args }) => callService('visualCultureService', 'analyzeVideo', args),
  'style.realism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'realism' }),
  'style.naturalism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'naturalism' }),
  'style.classicism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'classicism' }),
  'style.romanticism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'romanticism' }),
  'style.baroque': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'baroque' }),
  'style.rococo': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'rococo' }),
  'style.geometric': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'geometric-abstraction' }),
  'style.abstract': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'abstraction' }),
  'style.minimalism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'minimalism' }),
  'style.maximalism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'maximalism' }),
  'style.surrealism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'surrealism' }),
  'style.cubism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'cubism' }),
  'style.futurism': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'futurism' }),
  'style.dada': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'dada' }),
  'style.pop-art': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'pop-art' }),
  'style.conceptual-art': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'conceptual-art' }),
  'style.performance-art': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'performance-art' }),
  'style.digital-art': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'digital-art' }),
  'style.bioart': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'bioart' }),
  'style.land-art': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'land-art' }),
  'style.installation': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'installation-art' }),
  'style.cinema': ({ args }) => callService('visualCultureService', 'classifyMovement', { ...args, movement: 'cinema' }),
