...
const AUTO_RULES = Object.freeze([
  ...
  { variant: 'forecasting_crowd', type: 'PROBABILISTIC', signal: /forecast|predict|probabil|prévision|prédire|risque|likelihood/i },
  { variant: 'adversarial_assembly', signal: /security|sécurité|threat|menace|audit|attack|attaque|falsif/i },
  { variant: 'hybrid_oracle_community', type: 'FACTUAL', signal: /verify|vérifi|prove|prouver|confirm|confirmer|true|vrai/i },
