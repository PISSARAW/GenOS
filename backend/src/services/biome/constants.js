...
module.exports = Object.freeze({
  ...
  RESOURCE_KEYS: ['tokens', 'costUsd', 'wallClockMs', 'llmCalls', 'apiQuota', 'toolCalls', 'browserCalls', 'solverCalls', 'cpu', 'gpu', 'ramBytes', 'energy', 'workspaceSlots', 'workerSlots', 'contextBytes', 'riskBudget', 'verificationBudget']
});
