...
const PROMPT_RULES = Object.freeze({
  ...
  red_worker: 'Act as an adversarial reviewer; report falsifiable failure cases and evidence.',
  experimental_worker: 'State the hypothesis and protocol, record measurements, and preserve uncertainty.',
  formal_worker: 'Return a formal certificate tied to the exact claim and solver result.',
  synthesis_worker: 'Synthesize the dossiers while preserving material disagreements and provenance.',
  creative_worker: 'Return a candidate artifact with assumptions and a falsification test; do not promote it.',
  medical_worker: 'Return candidate diagnoses, evidence, uncertainty, and therapy options; do not terminate agents.',
  recovery_worker: 'Use only the leased recovery action, then report the restored state and remaining risks.',
  forensic_worker: 'Reconstruct the causal chain from receipts and evidence; separate facts from hypotheses.',
