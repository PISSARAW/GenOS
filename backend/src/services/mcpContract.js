...
const TOOL_BASE_SCHEMAS = {
  ...
  genos_topology_session: {
    ...
    properties: {
      ...
      operation: { type: 'string', enum: ['snapshot', 'apply', 'deposit', 'direct_member', 'route', 'slime', 'gap', 'grow', 'evaporate', 'record_outcome', 'conductivity', 'bridge', 'signal', 'locus', 'repair', 'prune', 'allocate', 'forage', 'health'] },
      ...
      bridge: { type: 'object' }, proof: { type: 'object' }, signal: { type: 'object' },
      action: { type: 'string', enum: ['assign', 'transfer', 'drop'] }, locus: { type: 'object' }, locus_id: { type: 'string' }, now: { type: 'number' }, max_idle_ms: { type: 'number' }, utility_threshold: { type: 'number' },
