...
const TOOL_BASE_SCHEMAS = {
  genos_orchestrate: {
    ...
    properties: {
      ...
      executor: { type: 'string', enum: ['caller_mcp', 'codex', 'local'], description: 'Cognitive executor. caller_mcp delegates generation to the connected MCP host.' },
  ...
  genos_delegate_worker: {
    ...
    properties: {
      ...
      executor: { type: 'string', enum: ['caller_mcp', 'codex', 'local'], description: 'Cognitive executor inherited by the worker.' },
