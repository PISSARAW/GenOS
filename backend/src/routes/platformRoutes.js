...
router.post('/platform/incidents/:incidentId/replay', requirePermission('read'), c.replay);
...
router.post('/platform/approvals/:id/decision', requirePermission('security:manage'), c.decideApproval);
