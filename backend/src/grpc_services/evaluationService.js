...
module.exports = {
  ...
  EvaluateDossier: (call, callback) => {
    try {
      ...
      callback(Object.assign(new Error(`Dossier evaluation failed: ${err.message}`), { code: 13 }));
    }
  },
  ...
  CalculateParetoFront: (call, callback) => {
    try {
      ...
      callback(Object.assign(new Error(`Pareto evaluation failed: ${err.message}`), { code: 13 }));
    }
  }
};
