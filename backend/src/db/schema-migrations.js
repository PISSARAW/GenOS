...
async function applyVersionedMigrations(db) {
  ...
  for (const table of ['prompts', 'datasets', 'rag_documents', 'integrations', 'workflows', 'workflow_runs', 'global_alerts', 'webhook_subscriptions', 'secrets', 'releases', 'model_jobs', 'evaluation_jobs', 'evaluation_runs', 'provenance_records', 'notification_preferences', 'genome_decisions', 'memory_synapses', 'trace_spans', 'telemetry_events']) {
