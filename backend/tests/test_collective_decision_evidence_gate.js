...
assert.equal(hasDecisionEvidence({ eventType: 'AGENT_FAILED', payload: {} }), false);
assert.equal(hasDecisionEvidence({ eventType: 'AGENT_FAILED', payload: { failure: { reason: 'boom' } } }), true);
