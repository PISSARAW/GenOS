...
async function run() {
  ...
  try {
    ...
    await assert.rejects(runtime.transitionRun({ db: {}, teamRunId: running.teamRunId, revision: running.revision, patch: { status: 'FORMING' } }), { code: 'ATEAM_RUN_TRANSITION_INVALID' });
