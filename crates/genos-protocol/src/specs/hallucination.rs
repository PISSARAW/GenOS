...
pub fn hallucination_specs() -> Vec<ToolSpec> {
    vec![
        SpecBuilder::new(
            ...
            "Scan for missing execution receipts.",
        )
        ...
        SpecBuilder::new(
            ...
            "Inject false premises for red teaming.",
        )
        .schema(object_schema([], &[]))
        .build(),
        SpecBuilder::new(
        ...
        SpecBuilder::new(
            ...
            "Analyze a trajectory with semantic entropy.",
        )
        .schema(object_schema([], &[]))
        .build(),
        SpecBuilder::new(
            ...
            "Correct hallucinations with process supervision.",
        )
        .schema(object_schema([], &[]))
        .build(),
        SpecBuilder::new(
            ...
            "Simulate hallucinations in an isolated world.",
        )
        .schema(object_schema([], &[]))
        .build(),
    ]
