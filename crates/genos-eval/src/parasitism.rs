use genos_core::{ids::GenomeId, AgentGenome};
...
mod tests {
    use super::*;
    use genos_core::{
        Chromosome, CognitionConfig, GenomeVersion, Identity, InferredGenomeTraitClaim, Locus,
        MemoryPolicy, ModelPolicy, ToolPolicy,
    };
