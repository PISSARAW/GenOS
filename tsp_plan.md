...
## Dataset
The dataset is evaluated dynamically in `tsp_evaluator.py`. The algorithm should expect a list of `(x, y)` tuples and return the shortest distance found.
...
- **Run Command**: `python tsp_evaluator.py greedy_solver.py`
...
- **Run Command**: `python tsp_evaluator.py sa_solver.py`
...
- **Run Command**: `python tsp_evaluator.py ga_solver.py`
