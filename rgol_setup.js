...
fs.writeFileSync('gen0_secret.txt', printGrid(currentGrid));
...
fs.writeFileSync('target_grid.txt', printGrid(currentGrid));
console.log('Grids generated: target_grid.txt (Gen 5) and gen0_secret.txt (Gen 0)');
